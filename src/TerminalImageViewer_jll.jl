module TerminalImageViewer_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import TerminalImageViewer_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("67e192b9-39bd-51f2-a859-4b6827b2b1d7"))
platforms = [Pkg.Artifacts.unpack_platform(e, "TerminalImageViewer", artifacts_toml) for e in artifacts["TerminalImageViewer"]]
...
if best_platform === nothing
    @debug("Unable to load TerminalImageViewer; unsupported platform $(triplet(platform_key_abi()))")
else
...
end  # module TerminalImageViewer_jll
